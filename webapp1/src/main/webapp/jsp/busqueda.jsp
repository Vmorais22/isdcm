    	...
    	<form action="/webapp1/servletREST" method="get">
        	<div class="form-row">
            	<div class="col-md-2">
                	...
                	<input type="text" name="titulo" class="form-control mb-2" id="inlineFormInput" placeholder="Título">
            	</div>
            	<div class="col-md-2">
                	<label class="sr-only" for="inlineFormInput">Autor</label>
                	<input type="text" name="autor" class="form-control mb-2" id="inlineFormInput" placeholder="Autor">
            	</div>
            	<div class="col-md-1">
                	<label class="sr-only" for="inlineFormCustomSelect">Año:</label>
                	<select class="custom-select" id="inlineFormCustomSelect" name="year">
            	...
            	<div class="col-md-1">
                	<label class="sr-only" for="inlineFormCustomSelect">Mes:</label>
                	<select class="custom-select" id="inlineFormCustomSelect" name="month">
            	...
            	<div class="col-md-1">
                	<label class="sr-only" for="inlineFormCustomSelect">Día:</label>
                	<select class="custom-select" id="inlineFormCustomSelect" name="day">
                	...
                	<tr>
                    	...
                    	<td>
                          ...
                          <form id="boardButton" action="/webapp1/servletREST" method="post">   
                                ...
                                <input type="hidden" name="currentVideoTitle" value=<%= URLEncoder.encode(vid.getTitle()) %>/>
                                <input type="hidden" name="currentVideoAuthor" value=<%= URLEncoder.encode(vid.getAuthor()) %>/>
                                <input type="hidden" name="currentVideoDescription" value=<%= URLEncoder.encode(vid.getDescription()) %>/>
